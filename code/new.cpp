...
private:
  ...
  void fixPhiNodes(BasicBlock *newHeader, BasicBlock *effHeader);
...
void SpecLICM::specHoistInst(LoadInst *li) {
  ...
  if (useFixup) {
    ...
    fixPhiNodes(aliasHeaderBB, effHeader);
...
// ---------------------------------------------------------------------------
void SpecLICM::fixPhiNodes(BasicBlock *newHeader, BasicBlock *effHeader) {
